...
/**
 * A {@link JwtDecoderFactory factory} that provides a {@link JwtDecoder} for
 * the specified {@link RegisteredClient} and is used for authenticating a
 * {@link Jwt} Bearer Token during OAuth 2.0 Client Authentication.
 *
...
public final class JwtPushedAuthorizationRequestDecoderFactory implements JwtDecoderFactory<RegisteredClient> {
	...
	/**
	 * Sets the factory that provides an {@link OAuth2TokenValidator} for the
	 * specified {@link RegisteredClient} and is used by the {@link JwtDecoder}. The
	 * default {@code OAuth2TokenValidator<Jwt>} factory is
	 * {@link #DEFAULT_JWT_VALIDATOR_FACTORY}.
	 *
	 * @param jwtValidatorFactory the factory that provides an
	 *                            {@link OAuth2TokenValidator} for the specified
	 *                            {@link RegisteredClient}
	 */
